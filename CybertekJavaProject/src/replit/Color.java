...
public class Color {
    ...
    public String toString() {
        ...
        String s = "n/a";
        if(Arrays.equals(rgb,WHITE)){ s = "white"; }
        if(Arrays.equals(rgb,LIGHT_GRAY)){ s = "light gray"; }
        if(Arrays.equals(rgb,GRAY)){ s = "gray"; }
        if(Arrays.equals(rgb,DARK_GRAY)){ s = "dark gray"; }
        if(Arrays.equals(rgb,RED)){ s = "red"; }
        if(Arrays.equals(rgb,BLACK)){ s = "black"; }
        if(Arrays.equals(rgb,PINK)){ s = "pink"; }
        if(Arrays.equals(rgb,BLUE)){ s = "blue"; }
        if(Arrays.equals(rgb,YELLOW)){ s = "yellow"; }
        if(Arrays.equals(rgb,GREEN)){ s = "green"; }
        if(Arrays.equals(rgb,ORANGE)){ s = "orange"; }
        if(Arrays.equals(rgb,MAGENTA)){ s = "magenta"; }
        if(Arrays.equals(rgb,CYAN)){ s = "cyan"; }


        return s; //change this to return colors
    }
