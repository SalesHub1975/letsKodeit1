...
public class Book {
     ...
     */
    public void setTitle(String title) { //capitalize, isTitleWord
        String str = "";
        title = title.trim();
        if (title.isEmpty()) {
            this.title = "";
            ...
            str = capitalize(arr[0]) + " ";
            for (int i = 1; i < arr.length; i++) {
                if (isTitleWord(arr[i]) == true) {
                    str += capitalize(arr[i]) + " ";
    ...
    public String toString() {
        String s = "author=" + this.author + ", title=" + this.title + ", id=" + this.id + ", pages=" + this.pages;
